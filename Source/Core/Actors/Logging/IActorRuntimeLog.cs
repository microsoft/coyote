...
namespace Microsoft.Coyote.Actors
{
    ...
    public interface IActorRuntimeLog
    {
        ...
        void OnCreateActor(ActorId id, string creatorType, string creatorName);
        ...
        void OnSendEvent(ActorId targetActorId, string senderType, string senderName, string senderStateName,
        ...
        void OnCreateMonitor(string monitorTypeName);
        ...
        /// <param name="actionName">The name of the action being executed.</param>
        void OnMonitorExecuteAction(string monitorTypeName, string stateName, string actionName);
        ...
        void OnMonitorProcessEvent(string monitorTypeName, string stateName, string senderType,
        ...
        /// <param name="stateName">The name of the state in which the event is being raised.</param>
        /// <param name="e">The event being raised.</param>
        void OnMonitorRaiseEvent(string monitorTypeName, string stateName, Event e);
        ...
        void OnMonitorStateTransition(string monitorTypeName, string stateName, bool isEntry, bool? isInHotState);
