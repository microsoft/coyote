...
{
    /// <summary>
    /// An object representing an awaitable long running operation involving one or more actors.
    ...
    /// completing some logical operation. Each actor can find the operation using
