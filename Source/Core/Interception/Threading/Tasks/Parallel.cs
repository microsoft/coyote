...
namespace Microsoft.Coyote.Interception
{
    ...
    public static class Parallel
    {
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(SystemTasks.Parallel.Invoke));
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(SystemTasks.Parallel.For));
            return SystemTasks.Parallel.For(fromInclusive, toExclusive, body);
        }
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(SystemTasks.Parallel.ForEach));
            return SystemTasks.Parallel.ForEach(source, body);
        }
