...
#pragma warning disable CA1068 // CancellationToken parameters must come last
    ...
    public class TaskFactory
    {
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(Task.Factory.StartNew));
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(Task.Factory.ContinueWhenAll));
        ...
        public Task ContinueWhenAny(Task[] tasks, Action<Task> continuationAction, CancellationToken cancellationToken,
            TaskContinuationOptions continuationOptions, TaskScheduler scheduler)
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(Task.Factory.ContinueWhenAny));
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(Task.Factory.FromAsync));
