...
namespace Microsoft.Coyote.Interception
{
    ...
    public static class ThreadPool
    {
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(SystemThreading.ThreadPool.BindHandle));
#if NET5_0
        ...
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(SystemThreading.ThreadPool.RegisterWaitForSingleObject));
        ...
        public static RegisteredWaitHandle UnsafeRegisterWaitForSingleObject(WaitHandle waitObject, WaitOrTimerCallback callBack,
            object state, TimeSpan timeout, bool executeOnlyOnce)
        {
            ExceptionProvider.FailOnUncontrolledInvocation(nameof(SystemThreading.ThreadPool.UnsafeRegisterWaitForSingleObject));
