...
namespace Microsoft.Coyote.TestingServices.Runtime
{
    ...
    internal sealed class MachineTestingRuntime : MachineRuntime
    {
        ...
        public override MachineId CreateMachine(Type type, Event e = null, Guid opGroupId = default) =>
            throw new NotSupportedException("Invoking 'ICoyoteRuntime.CreateMachine' is not supported in this testing mode.");
        ...
        public override Task<MachineId> CreateMachineAndExecuteAsync(Type type, Event e = null, Guid opGroupId = default) =>
            throw new NotSupportedException("Invoking 'ICoyoteRuntime.CreateMachineAndExecuteAsync' is not supported in this testing mode.");
        ...
        public override Task<MachineId> CreateMachineAndExecute(Type type, Event e = null, Guid opGroupId = default) =>
            throw new NotSupportedException("Invoking 'ICoyoteRuntime.CreateMachineAndExecute' is not supported in this testing mode.");
        ...
        public override void SendEvent(MachineId target, Event e, Guid opGroupId = default, SendOptions options = null) =>
            throw new NotSupportedException("Invoking 'ICoyoteRuntime.SendEvent' is not supported in this testing mode.");
        ...
        public override Task<bool> SendEventAndExecuteAsync(MachineId target, Event e, Guid opGroupId = default, SendOptions options = null) =>
            throw new NotSupportedException("Invoking 'ICoyoteRuntime.SendEventAndExecuteAsync' is not supported in this testing mode.");
        ...
        public override Task<bool> SendEventAndExecute(MachineId target, Event e, Guid opGroupId = default, SendOptions options = null) =>
            throw new NotSupportedException("Invoking 'ICoyoteRuntime.SendEventAndExecute' is not supported in this testing mode.");
