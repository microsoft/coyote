...
namespace Microsoft.Coyote.TestingServices
{
    ...
    public sealed class TestingEngine
    {
        ...
        private TestingEngine(Configuration configuration, TestMethodInfo testMethodInfo)
        {
            ...
            else if (configuration.SchedulingStrategy == SchedulingStrategy.Interactive)
            {
        ...
        /// </summary>
        private void InitializeCustomLogging(SystematicTestingRuntime runtime)
        {
        ...
        /// </summary>
        private void GatherTestingStatistics(SystematicTestingRuntime runtime)
        {
