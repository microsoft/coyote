    ...
    public class ChainReplicationTest : BaseTest
    {
        ...
        private class Environment : StateMachine
        {
            ...
            private void InitOnEntry()
            {
                ...
                for (int i = 0; i < this.NumOfServers; i++)
                {
                    ...
                    if (i == 0)
                    {
                        server = this.CreateStateMachine(
                ...
                this.Clients.Add(this.CreateStateMachine(
                    typeof(Client),
                ...
                this.ChainReplicationMaster = this.CreateStateMachine(
        ...
        private class ChainReplicationMaster : StateMachine
        {
            ...
            private void InitOnEntry()
            {
                ...
                this.FailureDetector = this.CreateStateMachine(
