...
namespace Microsoft.Coyote.BugFinding.Tests.ConcurrencyFuzzing
{
    public class TaskInterleavingsTests : BaseBugFindingTest
    {
        ...
        public void TestInterleavingsWithNestedParallelTasks()
        {
            ...
            configuration: GetConfiguration().WithConcurrencyFuzzingEnabled().WithTestingIterations(500),
            expectedError: "Value is 3 instead of 5.");
        }
        ...
        public void TestExploreAllInterleavings()
        {
            ...
            configuration: GetConfiguration().WithConcurrencyFuzzingEnabled().WithTestingIterations(1000),
