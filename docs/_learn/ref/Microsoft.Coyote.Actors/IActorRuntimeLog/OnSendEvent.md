...
section: learn
title: OnSendEvent
permalink: /learn/ref/Microsoft.Coyote.Actors/IActorRuntimeLog/OnSendEvent
---
...
```csharp
public void OnSendEvent(ActorId targetActorId, string senderType, string senderName, 
