...
section: learn
title: CreateActor
permalink: /learn/ref/Microsoft.Coyote.Runtime/IActorRuntime/CreateActor
---
...
Creates a new actor of the specified type, using the specified [`ActorId`](../../Microsoft.Coyote.Actors/ActorIdType). This method optionally passes an [`Event`](../../Microsoft.Coyote/EventType) to the new actor, which can only be used to access its payload, and cannot be handled.
