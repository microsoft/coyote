...
| [WithPartiallyControlledTestingEnabled](Configuration/WithPartiallyControlledTestingEnabled)(…) | Updates the configuration with partially controlled testing enabled or disabled. |
