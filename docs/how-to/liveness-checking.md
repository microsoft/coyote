...
```plain
coyote test ./Samples/bin/net6.0/CoffeeMachineActors.dll -i 10 -ms 200 -s portfolio
```
...
```plain
coyote test ./Samples/bin/net6.0/CoffeeMachineActors.dll -i 10 -ms 1000 -s portfolio
```
