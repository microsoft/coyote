...
Waits to receive an [`Event`](../Event.md) of the specified types that satisfy the specified predicates.
...
Waits to receive an [`Event`](../Event.md) of the specified types.
...
Waits to receive an [`Event`](../Event.md) of the specified type that satisfies an optional predicate.
