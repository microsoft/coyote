...
Creates a new actor of the specified Type and with the specified optional [`Event`](../Event.md). This event is given to the Event) method on the new actor.
...
Creates a new actor of the specified type, using the specified [`ActorId`](../ActorId.md). This method optionally passes an [`Event`](../Event.md). This event is given to the InitializeAsync method on the new actor.
...
Creates a new actor of the specified Type and name, and with the specified optional [`Event`](../Event.md). This event is given to the Event) method on the new actor.
