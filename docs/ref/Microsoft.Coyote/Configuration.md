...
| [WithDgmlTraceVisualizationFormatEnabled](Configuration/WithDgmlTraceVisualizationFormatEnabled.md)() | Updates the configuration to use DGML formatting for execution trace visualization. |
...
| [WithGraphVizTraceVisualizationFormatEnabled](Configuration/WithGraphVizTraceVisualizationFormatEnabled.md)() | Updates the configuration to use GraphViz formatting for execution trace visualization. |
