...
| [WithRelaxedTestingEnabled](Configuration/WithRelaxedTestingEnabled.md)(…) | Updates the configuration with partially controlled testing enabled or disabled. If this option is enabled, systematic testing supports partially controlled executions. |
