...
| [WithMemoryAccessRaceCheckingEnabled](Configuration/WithMemoryAccessRaceCheckingEnabled.md)(…) | Updates the configuration with race checking at memory-access locations enabled or disabled. If this race checking strategy is enabled, then the runtime will explore interleavings at memory-access locations. |
