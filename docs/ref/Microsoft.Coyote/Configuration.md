...
| [WithPartiallyControlledTestingEnabled](Configuration/WithPartiallyControlledTestingEnabled.md)(…) | Updates the configuration with partially controlled testing enabled or disabled. |
