...
| [WithPartiallyControlledConcurrencyAllowed](Configuration/WithPartiallyControlledConcurrencyAllowed.md)(…) | Updates the configuration with partial controlled concurrency enabled or disabled. |
